package com.srctech.store.config;

import com.srctech.store.security.*;
import com.srctech.store.security.jwt.*;
...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    public void configure(HttpSecurity http) throws Exception {
        http.csrf().disable().addFilterBefore(corsFilter, UsernamePasswordAuthenticationFilter.class)
                ...
                .permitAll().antMatchers("/api/account/reset-password/finish").permitAll().antMatchers("/api/customers")
                .hasAuthority(AuthoritiesConstants.ADMIN).antMatchers("/api/product-categories")
