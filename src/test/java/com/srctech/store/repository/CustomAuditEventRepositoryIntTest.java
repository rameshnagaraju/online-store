package com.srctech.store.repository;

import com.srctech.store.StoreApp;
import com.srctech.store.config.Constants;
import com.srctech.store.config.audit.AuditEventConverter;
import com.srctech.store.domain.PersistentAuditEvent;
...
import static com.srctech.store.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
